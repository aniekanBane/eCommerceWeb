...
namespace eCommerceWeb.Migrator.StoreMigrations
{
    ...
    [Migration("20250118004450_MarketingAggInit")]
    partial class MarketingAggInit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eCommerceWeb.Domain.Entities.CustomerAggregate.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id")
                    ...
                    b.HasIndex("EmailAddress")
                        .IsUnique()
                        .HasDatabaseName("ix_customer_email_address");
            ...
            modelBuilder.Entity("eCommerceWeb.Domain.Entities.Subcriber", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subcriber");

                    b.HasIndex("EmailAddress")
                        .IsUnique()
                        .HasDatabaseName("ix_subcriber_email_address");

                    b.ToTable("subcriber", (string)null);
                });
                    ...
                    b.OwnsOne("eCommerceWeb.Domain.ValueObjects.Name", "Name", b1 =>
                        {
                            ...
                            NpgsqlIndexBuilderExtensions.IncludeProperties(b1.HasIndex("Fullname"), new[] { "Firstname", "Lastname" });
                    ...
                    b.OwnsOne("eCommerceWeb.Domain.ValueObjects.Name", "Name", b1 =>
                        {
                            ...
                            b1.HasKey("SubcriberId");

                            b1.HasIndex("Fullname")
                                .HasDatabaseName("ix_subcriber_fullname");

                            NpgsqlIndexBuilderExtensions.IncludeProperties(b1.HasIndex("Fullname"), new[] { "Firstname", "Lastname" });

                            b1.ToTable("subcriber");

                            b1.WithOwner()
                                .HasForeignKey("SubcriberId")
                                .HasConstraintName("fk_subcriber_subcriber_id");
                        });
